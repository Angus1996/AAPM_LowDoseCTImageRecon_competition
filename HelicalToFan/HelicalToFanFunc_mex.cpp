...
//  	float* PData = NULL;
//  	int* mark = NULL;
//  	float* ViewAngles = NULL;
//  	try{
//  		PData = new float[DefTimes * DetWidth];
//  		mark = new int[DefTimes * DetWidth];
//  		ViewAngles = new float[DefTimes];
//  	}catch(std::bad_alloc & ba)
//  	{
//  		std::cerr<<"std::bad_alloc allocation caught: "<<ba.what()<<"\n";
//  	}
