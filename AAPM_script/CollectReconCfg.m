...
cfg.DataCollectionDiameter = cov_uint8_to_double(info.Unknown_0018_0090);

%% The pitch
% cfg.SpiralPitchFactor = info.SpiralPitchFactor; %0.6 in L067 data
cfg.SpiralPitchFactor = cov_8uint8_to_double(info.Unknown_0018_9311); %0.6 in L067 data
